...
link:{root}/doc/nerva-cpp.adoc#extending[Extending the library] of the {cpp} manual.
...
[source,python]
----
include::{root}/src/python-bindings.cpp[tag=softmax_cross_entropy_loss]
----
...
[source,python]
----
include::{root}/python/nerva/loss_functions.py[tag=softmax_cross_entropy_loss]
----
